...
public class Playlist implements Comparable<Playlist>{
    ...
    private QueueInterface<Song> songList;
    ...
    public Playlist(int playlistID, String playlistName, QueueInterface<Song> songList) {
        this.playlistID = playlistID;
        this.playlistName = playlistName;
    ...
    public QueueInterface<Song> getSongList() {
        return songList;
    }

    public void setSongList(QueueInterface<Song> songList) {
        this.songList = songList;
    }
